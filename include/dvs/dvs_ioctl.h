...
#define DVS_GET_REMOTE_FS_MAGIC \
 _IOWR(DVS_IOCTL_IDENT, 0, unsigned long)

/* ioctls to get/set the DVS block size for a file */
#define DVS_GET_FILE_BLK_SIZE \
 _IOWR(DVS_IOCTL_IDENT, 1, int)

#define DVS_SET_FILE_BLK_SIZE \
 _IOWR(DVS_IOCTL_IDENT, 3, int)

/* ioctls to get/set the DVS stripe width (maxnodes) for a file */
#define DVS_GET_FILE_STRIPE_WIDTH \
 _IOWR(DVS_IOCTL_IDENT, 2, int)

#define DVS_SET_FILE_STRIPE_WIDTH \
 _IOWR(DVS_IOCTL_IDENT, 4, int)

/* ioctls to get/set the DVS datasync option for a file */
#define DVS_GET_FILE_DATASYNC \
 _IOWR(DVS_IOCTL_IDENT, 5, short)

#define DVS_SET_FILE_DATASYNC \
 _IOWR(DVS_IOCTL_IDENT, 6, short)

/* ioctls to get/set the DVS cache option for a file */
#define DVS_GET_FILE_CACHE \
 _IOWR(DVS_IOCTL_IDENT, 7, short)

#define DVS_SET_FILE_CACHE \
 _IOWR(DVS_IOCTL_IDENT, 8, short)

/* ioctls to get/set the DVS closesync  option for a file */
#define DVS_GET_FILE_CLOSESYNC \
 _IOWR(DVS_IOCTL_IDENT, 9, short)

#define DVS_SET_FILE_CLOSESYNC \
 _IOWR(DVS_IOCTL_IDENT, 10, short)

/* ioctls to get/set the DVS killprocess option for a file */
#define DVS_GET_FILE_KILLPROCESS \
 _IOWR(DVS_IOCTL_IDENT, 11, short)

#define DVS_SET_FILE_KILLPROCESS \
 _IOWR(DVS_IOCTL_IDENT, 12, short)
...
#define DVS_GET_FILE_ATOMIC \
 _IOWR(DVS_IOCTL_IDENT, 15, short)

#define DVS_SET_FILE_ATOMIC \
 _IOWR(DVS_IOCTL_IDENT, 16, short)

/* ioctls to get/set the DVS deferopens option for a file */
#define DVS_GET_FILE_DEFEROPENS \
 _IOWR(DVS_IOCTL_IDENT, 17, short)

#define DVS_SET_FILE_DEFEROPENS \
 _IOWR(DVS_IOCTL_IDENT, 18, short)

/* ioctls to get/set the DVS cache_read_sz option for a file */
#define DVS_GET_FILE_CACHE_READ_SZ \
 _IOWR(DVS_IOCTL_IDENT, 19, unsigned int)

#define DVS_SET_FILE_CACHE_READ_SZ \
 _IOWR(DVS_IOCTL_IDENT, 20, unsigned int)
 ...
 */ 
#define DVS_GET_NNODES \
 _IOWR(DVS_IOCTL_IDENT, 21, int)
...
#define DVS_TUNNEL_IOCTL \
 _IOWR(DVS_IOCTL_IDENT, 22, struct dvs_ioctl_tunnel)

#define DVS_BCAST_IOCTL \
 _IOWR(DVS_IOCTL_IDENT, 23, struct dvs_ioctl_tunnel)
